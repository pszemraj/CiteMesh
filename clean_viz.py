#!/usr/bin/env python3
"""
Clean reference tool-style visualization with proper node limiting
"""
...
def build_limited_graph(paper_id, max_papers=40):
    """Build a limited citation graph similar to reference tool."""
...
def compute_reference_tool_layout(graph):
    """Compute layout similar to reference tool."""
...
def visualize_clean(graph, output_path):
    ...
    # Compute layout
    pos = compute_reference_tool_layout(graph)
