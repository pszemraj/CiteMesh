...
Versioned metadata migrations rescan the selected source split and update cached publication years, DOIs, and venues in place while preserving vectors and corpus membership.
