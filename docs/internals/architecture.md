...
| `embedding` | Load/stream corpus and compute semantic neighbors | Embedding cache integration and capped edge pruning |
...
- `citemesh/data/embedding_cache.py` manages SQLite/HDF5 embedding cache state.
