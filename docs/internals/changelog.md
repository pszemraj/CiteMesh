...
- Extended that availability distinction through references, citations,
...
- Persistent embeddings now partition on the runtime-active checkpoint, requested
  revision, immutable commit or complete local artifact manifest, representation,
