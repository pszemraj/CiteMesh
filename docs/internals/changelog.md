...
- Static layouts now scaffold disconnected community groups, orient their longer extent horizontally, cap non-seed labels by citation priority, and suppress renderer-measured text overlaps so dense PNG exports use the canvas and remain legible.
