...
class EmbeddingPapersBuilder:
    ...
    def compute_embeddings(self):
        ...
        with open(self.embeddings_cache, "wb") as f:
            pickle.dump({"embeddings": self.embeddings, "paper_ids": self.paper_ids}, f)
    ...
    def build_similarity_graph(
        ...
        selected_indices = [
            self.paper_ids.index(pid) for pid, _ in seed_papers if pid in self.paper_ids
        ]
...
def visualize_embedding_graph(
    graph: nx.Graph, output_path: Path, iterations: int = 200
):
