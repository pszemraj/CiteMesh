#!/usr/bin/env python3
"""
Connected Papers-style visualization with proper similarity-based layout.
...
class ConnectedStyleBuilder:
    """Build Connected Papers-style visualizations with proper similarity layout."""
    ...
    def create_visualization(
        ...
        """Create the Connected Papers-style HTML visualization."""
...
<html>
<head>
    <title>Connected Papers: {root_title[:50]}</title>
    <meta charset="utf-8">
    <style>
...
def main():
    parser = argparse.ArgumentParser(description="Create Connected Papers-style visualizations")
